...
import com.estore.api.estoreapi.persistance.*;
...
public class ProductController {
    ...
    public ResponseEntity<Product[]> getProducts() {
        ...
        try{
            Product[] PArr = productDao.getProducts();
            if (PArr != null){
                return new ResponseEntity<Product[]>(PArr, HttpStatus.OK);
            }
            else{
                return new ResponseEntity<>(HttpStatus.NOT_FOUND);                                                              
            }
    ...
    public ResponseEntity<Product[]> searchProducts(@RequestParam String name) {
        ...
        try{
            Product[] PArr = productDao.findProducts(name);
            return new ResponseEntity<Product[]>(PArr, HttpStatus.OK);
    ...
    public ResponseEntity<Product> deleteProduct(@PathVariable int id) {
        ...
        try{
            boolean y = productDao.deleteProduct(id);
            if (y == true){
